...
class CRUDBase:
    ...
    async def get_not_fullyinvested_objs(
            self,
            session: AsyncSession,
    ):
        """
        Return a list of Model instances
        where the fully_invested field is False.
    ...
    async def update(
        ...
        await self.close_item_if_needed(db_obj)
    ...
    async def close_item_if_needed(self, item):
